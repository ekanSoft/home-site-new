...
export const projects: WorkProject[] = [
  {
    title: 'FX Buckley Butchers',
    slug: 'fx-buckley-butchers',
    category: 'ecommerce-website',
    summary:
      'Online store for a well-known Dublin butcher, with product catalog and checkout for premium meat boxes.',
    image: '',
    href: '',
  ...
  },
  {
    ...
    category: 'ecommerce-website',
    summary:
      'Florist e-commerce website with product galleries, occasion-based browsing, and online ordering.',
    image: '',
    href: '',
    source: 'freelance-contract',
    tags: ['E-commerce', 'Retail'],
